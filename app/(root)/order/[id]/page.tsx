  ...
  if (!res.success || !res.data) {
    return (
      <div className="max-w-xl mx-auto py-20 text-center space-y-4">
        ...
        <Link href="/shop" className="text-xs font-bold text-amber-800 underline">
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-8">
      <div className="bg-white p-8 sm:p-12 rounded-3xl border border-gray-200 shadow-xl text-center space-y-6">
        ...
        <div className="bg-amber-950 text-amber-50 p-6 rounded-2xl border border-amber-900/50 max-w-lg mx-auto text-xs space-y-3 text-left">
          ...
          <div className="flex justify-between border-b border-amber-900 pb-2">
            ...
            <span className="font-bold text-amber-400">Cash on Delivery (COD)</span>
          </div>
        ...
        <div className="flex justify-center gap-4 pt-4">
          <Link
            href="/account"
            className="px-6 py-3 bg-amber-950 text-amber-300 font-bold text-xs uppercase tracking-widest rounded-xl hover:bg-amber-900 transition shadow"
          >
            Track Order Status
          </Link>
          <Link
